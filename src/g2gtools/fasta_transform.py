...
def process_piece(
    ...
    logger.debug(
        f'params:output_region={fasta_transform_params.output_region}'
    )
    logger.debug(
        f'params:output_header={fasta_transform_params.output_header}'
    )
    ...
    logger.info(
        f'Transforming complete: {fasta_transform_params.input_region}'
    )
